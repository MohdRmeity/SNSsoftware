<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Administration_FileManagement.aspx.vb" Inherits="SNSsoftware.Cufex_Administration_FileManagement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
        ...
        <div class="MainHeader">
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        <div class="MainPageTitle" data-id="FILEMANAGEMENT">
                            File Management
                        </div>
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" class="MyFields" value="AddDate" data-columnname="Log Date" data-priority="7" data-hidden="false" />
    </div>
</asp:Content>