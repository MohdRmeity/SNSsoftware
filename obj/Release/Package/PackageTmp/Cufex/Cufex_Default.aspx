...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
    <div class="NormalDiv1118Max ZeroPadding">
        ...
        <dx:ASPxDashboard ID="ASPxDashboard1" runat="server" ClientInstanceName="webDesigner" AllowExportDashboardItems="True" OnCustomParameters="ASPxDashboard1_CustomParameters" Height="1000px" OnConfigureDataReloadingTimeout="ASPxDashboard1_ConfigureDataReloadingTimeout" OnConnectionError="ASPxDashboard1_ConnectionError">
