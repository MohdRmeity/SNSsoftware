<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Configuration_Suppliers.aspx.vb" Inherits="SNSsoftware.Cufex_Configuration_Suppliers" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
            ...
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        ...
                        <div class="MainPageDesc" data-text="Suppliers List">
                            Suppliers List
                        </div>
                    </div>
                    <table class="floatR">
                        <tr>
                            ...
                            <td>
                                <a id="btnAddNew" runat="server" class="btnAddNew AnimateMe">New Supplier
                                </a>
                            </td>
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" class="HiddenDetailLink" value="<%= Server.UrlDecode(Page.GetRouteUrl("SNSsoftware-Cufex-Configuration_Suppliers", Nothing)) %>" />
        <input type="hidden" id="HiddenID" runat="server" class="HiddenID" value="0" />

        <input type="hidden" class="MyFields" value="StorerKey" data-columnname="Supplier" data-priority="1" data-hidden="false" data-primarykey="true" />
