<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Administration_ExportLogs.aspx.vb" Inherits="SNSsoftware.Cufex_ExportLogs" %>
        ...
        <div class="MainHeader">
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        <div class="MainPageTitle" data-id="LOGSEXPORT">
                            Export Logs
                        </div>
                        <div class="MainPageDesc">
                            Manage your export logs
                        </div>
                    </div>
                    <table class="floatR">
                        <tr>
        ...
        <div style="position: relative; padding-top: 25px; width: 100%;" class="HeaderGridView content_3">
            <table class="GridContainer" data-resizemode="fit">
                <tr class="GridRow GridAdjust">
                    ...
                    <td class="GridCell GridHead" data-id="RecordsCount">
                        <span class="MyTitleHead">Records Count</span>
                        <div class="AbsoSorting">
                            <div class="SortUp"></div>
                            <div class="SortDown"></div>
                        </div>
                ...
                <tr class="GridRow SearchStyle" id="SearchRow" runat="server">
                    ...
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="RecordsCount" />
                    </td>
