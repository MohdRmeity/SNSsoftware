<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Security_Profile_Users.aspx.vb" Inherits="SNSsoftware.Cufex_Security_Profile_Users" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" class="HiddenDetailLink" value="<%= Server.UrlDecode(Page.GetRouteUrl("SNSsoftware-Cufex-Security_Profile_Users", Nothing)) %>" />
