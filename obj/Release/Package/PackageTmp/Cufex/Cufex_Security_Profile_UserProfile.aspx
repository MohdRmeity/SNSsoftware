<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Security_Profile_UserProfile.aspx.vb" Inherits="SNSsoftware.Cufex_Security_Profile_UserProfile" %>
        ...
        <div class="MainHeader">
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        <div class="MainPageTitle" data-id="USERPROFILE">
                            User Profile
                        </div>
                        <div class="MainPageDesc">
                            Manage portal user profile
                        </div>
                    </div>
                    <table class="floatR">
                        <tr>
        ...
        <div style="position: relative; padding-top: 25px; width: 100%;" class="HeaderGridView content_3">
            <table class="GridContainer" data-resizemode="fit">
                <tr class="GridRow GridAdjust">
                    ...
                    <td class="GridCell GridHead" data-id="ProfileName">
                    ...
                    <td class="GridCell GridHead borderRight0" data-id="UserKey">
