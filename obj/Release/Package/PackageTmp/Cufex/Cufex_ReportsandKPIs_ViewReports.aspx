<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_ReportsandKPIs_ViewReports.aspx.vb" Inherits="SNSsoftware.Cufex_ReportsandKPIs_ViewReports" %>
            ...
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    ...
                    <table class="floatR">
                        <tr>
                            <td>
                                <a id="btnQuickEntry" runat="server" class="btnQuickEntry AnimateMe" href="ReportsandKPIs/ReportDesigner">Report Designer
                                </a>
                            </td>
