<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Administration_FileManagementLogs.aspx.vb" Inherits="SNSsoftware.Cufex_Administration_FileManagementLogs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
        ...
        <div class="MainHeader">
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        <div class="MainPageTitle" data-id="LOGSFILES">
                            File Management Logs
                        </div>
                        <div class="MainPageDesc">
                            Manage your uploaded files logs
                        </div>
                    </div>
                    <table class="floatR">
                        <tr>
        ...
        <div style="position: relative; padding-top: 25px; width: 100%;" class="HeaderGridView content_3">
            <table class="GridContainer" data-resizemode="fit">
                <tr class="GridRow GridAdjust">
                    ...
                    <td class="GridCell GridHead" data-id="AddWho">
                    ...
                    <td class="GridCell GridHead" data-id="WhseID">
                        <span class="MyTitleHead">Warehouse</span>
                        <div class="AbsoSorting">
                            <div class="SortUp"></div>
                            <div class="SortDown"></div>
                        </div>
                    </td>
                    <td class="GridCell GridHead" data-id="RecKey">
                        <span class="MyTitleHead">Record Key</span>
                        <div class="AbsoSorting">
                            <div class="SortUp"></div>
                            <div class="SortDown"></div>
                        </div>
                    ...
                    <td class="GridCell GridHead" data-id="ActivityType">
                        <span class="MyTitleHead">Activity Type</span>
                        <div class="AbsoSorting">
                            <div class="SortUp"></div>
                            <div class="SortDown"></div>
                        </div>
                ...
                <tr class="GridRow SearchStyle" id="SearchRow" runat="server">
                    ...
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="AddWho" />
                    </td>
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="ScreenName" />
                    </td>
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="WhseID" />
                    </td>
                    <td class="GridCell GridHeadSearch">
                    ...
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="ActivityType" />
                    </td>
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" id="SortBy" value="ScreenName asc, SerialKey desc" />

        <input type="hidden" class="MyFields" value="AddWho" data-columnname="User ID" data-priority="1" data-hidden="false" data-primarykey="true" />
