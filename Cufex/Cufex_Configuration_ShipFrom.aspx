...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
                ...
                <div class="floatL Width100">
                    ...
                    <table class="floatR">
                        <tr>
                            ...
                            <td style="width: 13px;"></td>
                            <td>
                                <a id="btnAddNew" runat="server" class="btnAddNew AnimateMe">New Ship From
                                </a>
                            </td>
            ...
            <table class="GridContainer" data-resizemode="overflow">
                <tr class="GridRow GridAdjust">
                    ...
                    <td class="GridCell GridHead" data-id="StorerKey">
                        <span class="MyTitleHead">Ship From</span>
                ...
                <div class="floatL Width100">
                    <div class="floatL Width100 u-overflowHidden NewHeaderRecord">
                        <div class="FloatRecordNew floatL">
                            <div class="FloatRecordTitleNew">Ship From<span>*</span></div>
                            <div>
                        ...
                        <div class="iWantMyChildrenFloatHeight">
                            <div class="floatL Width100 RecordHeader">
                                <div class="FloatRecord floatL">
                                    ...
                                    <div class="FloatRecordTitle floatL">Ship From*</div>
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" class="HiddenDetailLink" value="<%= Server.UrlDecode(Page.GetRouteUrl("SNSsoftware-Cufex-Configuration_ShipFrom", Nothing)) %>" />
        <input type="hidden" id="HiddenID" runat="server" class="HiddenID" value="0" />

        <input type="hidden" class="MyFields" value="StorerKey" data-columnname="Ship From" data-priority="1" data-hidden="false" data-primarykey="true" />
