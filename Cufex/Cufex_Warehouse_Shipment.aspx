<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Cufex/Cufex_Site.Master" CodeBehind="Cufex_Warehouse_Shipment.aspx.vb" Inherits="SNSsoftware.Cufex_Warehouse_Shipment" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cufex_MainContent" runat="server">
        ...
        <div class="MainHeader">
            <div class="iWantMyChildrenFloatHeight" style="position: relative;">
                <div class="floatL Width100">
                    <div class="floatL">
                        <div class="MainPageTitle" data-id="Warehouse_SO">
                            Shipment Order
                        </div>
                        ...
                        <tr>
                            ...
                            <td id="TableAction2" runat="server">
                                ...
                                <div class="ActionHiddenButtons">
                                    <div class="BtnDoSomeThing AnimateMe" data-id="1"><span class="ion-ios-trending-up MyFontIon"></span><span style="vertical-align: 4px;">Allocate</span></div>
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <div style="position: relative; padding-top: 25px; width: 100%;" class="HeaderGridView content_3">
            <table class="GridContainer" data-resizemode="overflow">
                ...
                <tr class="GridRow SearchStyle" id="SearchRow" runat="server">
                    ...
                    <td class="GridCell GridHeadSearch" style="overflow:visible;">
                        <select data-placeholder="Search" multiple class="chosen-select SearchClass InputOrderStatusSearch" data-id="Status" data-mode="single">
                        </select>
                    </td>
                    <td class="GridCell GridHeadSearch" style="overflow:visible;">
                        <select data-placeholder="Search" multiple class="chosen-select SearchClass InputOrderTypeSearch" data-id="OrderType" data-mode="single">
                        </select>
                    </td>
                    <td class="GridCell GridHeadSearch">
                    ...
                    <td class="GridCell GridHeadSearch">
                        <input type="text" placeholder="Search" class="SearchClass" data-id="CAST(ActualShipDate AS date)" />
                    </td>
                    <td class="GridCell GridHeadSearch">
                ...
                <div class="floatL Width100">
                    <div class="floatL Width100 u-overflowHidden NewHeaderRecord">
                        ...
                        <div class="FloatRecordNew floatL">
                            ...
                            <div>
                                <input type="text" class="textRecordStyle InputOrderKey" data-value="Auto Generated" data-disabled="" />
                            </div>
                        </div>
                        <div class="FloatRecordNew floatL">
                        ...
                        <div class="FloatRecordNew floatL">
                            ...
                            <div>
                                <input type="text" class="textRecordStyle datepicker InputOrderDate" data-value="<%= Format(Now, "MM/dd/yyyy")  %>" data-disabled="disabled" />
                            </div>
                        </div>
                        <div class="FloatRecordNew floatL">
                            <div class="FloatRecordTitleNew">Status</div>
                            <div>
                                <input type="text" class="textRecordStyle InputStatus" data-value="Created Externally" data-disabled="" />
                            </div>
                        </div>
                        <div class="FloatRecordNew floatL">
                        ...
                        <div class="FloatRecordNew floatL">
                            <div class="FloatRecordTitleNew">Actual Ship Date</div>
                            <div>
                                <input type="text" class="textRecordStyle datepicker InputActualShipDate" data-disabled="" />
                            </div>
                        </div>
                        <div class="FloatRecordNew floatL">
                    ...
                    <div class="floatL Width100 NewDetailRecord">
                        ...
                        <div class="Details_FloatRecordNew floatL">
                            <div class="Details_FloatRecordTitleNew">UDF5</div>
                            <div>
                                <input type="text" class="Details_textRecordStyle InputDetailsSUsr5" data-disabled="" />
                            </div>
                        </div>
                        <div class="Details_FloatRecordNew floatL">
                    ...
                    <div style="position: relative; height: 500px; width: 100%;" class="MyContainerPopup GetFullHeightForPopup content_4">
                        <div class="iWantMyChildrenFloatHeight">
                            <div class="floatL Width100 RecordHeader">
                                ...
                                <div class="FloatRecord floatL">
                                    <div class="FloatRecordTitle floatL">Actual Ship Date</div>
                                    <div class="FloatRecordField floatL">
                                        <input type="text" class="textRecordStyle datepicker InputActualShipDate" data-disabled="" />
                                    </div>
                                </div>
                                ...
                                <div class="RecordsContainer_Inside" style="display: none; position: relative;">
                                    ...
                                    <div class="iWantMyChildrenFloatHeight">
                                        <div class="floatL Width100">
                                            ...
                                            <div class="Details_FloatRecord floatL">
                                                <div class="Details_FloatRecordTitle floatL">UDF5</div>
                                                <div class="Details_FloatRecordField floatL">
                                                    <input type="text" class="Details_textRecordStyle InputDetailsSUsr5" data-disabled="" />
                                                </div>
                                            </div>
    ...
    <div class="FormSettings">
        ...
        <input type="hidden" class="MyFields" value="OrderType" data-columnname="Type" data-priority="8" data-hidden="false" />
        ...
        <input type="hidden" class="MyFields" value="ActualShipDate" data-columnname="Actual Ship Date" data-priority="11" data-hidden="false" />
        <input type="hidden" class="MyFields" value="SUsr1" data-columnname="UDF1" data-priority="12" data-hidden="false" />
        <input type="hidden" class="MyFields" value="SUsr2" data-columnname="UDF2" data-priority="13" data-hidden="false" />
        <input type="hidden" class="MyFields" value="SUsr3" data-columnname="UDF3" data-priority="14" data-hidden="false" />
