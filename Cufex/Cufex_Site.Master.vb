...
Public Class Cufex_Site
    ...
    Public Sub FixMenuVisibleItems()
        ...
        If Session("userkey") IsNot Nothing Then
            ...
            DivMain_Administration.Visible = DivSubMain_Administration_ExportLogs.Visible Or DivSubMain_Administration_ImportLogs.Visible Or DivSubMain_Administration_FileManagementLogs.Visible Or DivSubMain_Administration_FileManagement.Visible Or DivSubMain_Administration_UITemplates.Visible
